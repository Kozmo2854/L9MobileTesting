var BurgerMenu = function(){
    ...
    this.LogOut = $$('ion-item-group[role="group"] ion-button')[2]
    this.Internship = $$('ion-item-group[role="group"] ion-button')[3]
    this.PrivacyPolicy = $$('ion-item-group[role="group"] ion-button')[4]
